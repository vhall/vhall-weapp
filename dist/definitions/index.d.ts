...
interface VhallComponentInstance {
...
export type VhallComponentOptions<Data extends WechatMiniprogram.Component.DataOption, Props extends WechatMiniprogram.Component.PropertyOption, Methods extends WechatMiniprogram.Component.MethodOption> = {
    data?: Data;
    field?: boolean;
    classes?: string[];
    mixins?: string[];
    ...
    mounted?: () => void;
    destroyed?: () => void;
} & ThisType<VhallComponentInstance & WechatMiniprogram.Component.Instance<Data & {
    name: string;
    value: any;
